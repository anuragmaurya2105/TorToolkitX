...
async def start_handler(event):
    msg = "Hello to watch movies <a href='https://t.me/quanta_movie'>Movies</a>. Dont forget to join discussion group."
...
async def about_me(message):
    ...
    msg = (
        ...
        "<b>Owner</b>:@ghost_freak_official\n\n"
